...
const Billing = () => {
  ...
  const [text, setText] = useState("Billing Overview");
  ...
  return (
    ...
    >
      ...
      >
        <button
          className={`sm:p-3 p-2 ml-5 rounded-lg text-lg 
    ${
      activeButton === "billing"
        ? "bg-[#BD695D] hover:bg-[#A13727] text-white"
        ...
        <button
          className={`sm:p-3 p-2 rounded-lg text-lg 
    ${
      activeButton === "voice"
        ? "bg-[#BD695D] hover:bg-[#A13727] text-white"
        : "relative pb-3 after:absolute after:left-0 after:bottom-0 after:w-0 after:h-[3px] after:bg-[#BD695D] after:transition-all after:duration-300 hover:after:w-full"
        ...
        <>
            ...
            >
              ...
              <div className="flex justify-between">
                ...
                <button
                  ...
                  className="items-center justify-center border rounded-lg bg-[#BD695D] hover:bg-[#A13727] p-3 text-white"
                >
                  Add Funds
                </button>
            ...
            <div
              className={`${
                isNightMode
                  ? "bg-customDarkGray text-white"
                  : "bg-white text-gray-700"
              } w-full shadow rounded-lg text-lg  p-5 my-4 sm:my-0 ${
                showForm ? "static" : "relative"
              }`}
            >
              Monthly Plan Name
              <p className="text-2xl font-bold mt-2">Starter</p>
              <p
                className={`text-green-700 bg-green-100 text-sm w-fit rounded-3xl p-2 mt-3 pl-4 pr-4 ${
                  showForm ? "static" : "absolute"
                } top-2 right-5`}
              >
                Active
              </p>
          ...
          >
            ...
            <div className="w-full h-3 bg-gray-200 rounded-full">
              <div
                className="absolute top-0 left-0 h-3 bg-[#BD695D] hover:bg-[#A13727] rounded-full"
        ...
        <div className="mt-4 border  rounded-xl p-7 h-screen ">
          ...
          >
            <div className="text-center flex flex-col justify-center items-center my-20">
              ...
              <button className="border flex text-white text-lg bg-[#BD695D]  hover:bg-[#A13727] rounded-lg px-5 p-3 items-center gap-2 mt-6">
                <img src="./images/svg.png" alt="" />
                Make Y our First Call
              </button>
            </div>
          </div>
        </div>
