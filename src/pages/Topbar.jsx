    ...
    <>
        ...
        <div ref={ProfileRef}>
          ...
          <div
            ...
            className="w-9 h-9 sm:w-12 sm:h-12 mr-10 bg-[#BD695D] hover:bg-[#A13727] rounded-full flex items-center justify-center text-white text-xl sm:text-3xl font-bold cursor-pointer absolute sm:static top-0 -right-8"
