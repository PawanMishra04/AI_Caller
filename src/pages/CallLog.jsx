...
const CallLog = () => {
  ...
  const [text, setText] = useState('Call Logs');
    ...
    >
          ...
          >
            ...
            <form className="">
              ...
              <div className="flex gap-5 justify-end">
                ...
                <button
                  type="submit"
                  className={`bg-pink-500 text-white px-20 py-3 rounded-lg ${
                    loading
      ...
      <div className="flex justify-between mt-10 flex-col md:flex-row">
        ...
        >
          ...
          <button
            onClick={() => setShowForm(true)}
            className="flex text-lg text-white bg-pink-500 rounded-md p-2 mr-4 font-medium hover:bg-pink-600"
          >
            <img src="./images/i.png" alt="" className="mr-2 ml-2 mt-1" />
            Call Numbers
          </button>
