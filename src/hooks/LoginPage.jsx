...
const LoginPage = () => {
  ...
  return (
    <div className="bg-[url('/bg-login.png')] bg-cover bg-center bg-no-repeat  flex justify-center items-center min-h-screen ">
      <div className="flex shado rounded-lg md:max-w-[95%] g-gray-300 flex-col md:flex-row md:items-center md:justify-center md:p-12 p-4 gap-6 lg:max-w-[80%] lg:max-h-[80%]">
        <img
          className="h-auto max-h-64 sm:max-h-96 md:max-h-[450px] lg:max-h-[600px] md:w-[50%] lg:w-[50%]"
          src="./images/SignIn.png"
          alt="Login"
        />


        <div className="shadow-lg flex- rounded-xl px-6 py-4 md:px-10 md:w-[800px] bg-white ">
          <div className="">
          ...
          <form onSubmit={loginUser} className="mt-8 flex flex-col gap-4">
            ...
            <button
              type="submit"
              className="bg-pink-500 hover:bg-pink-600 text-center py-3 rounded-xl mt-4 text-white font-semibold md:mb-5"
            >
               {isLogin ? (
